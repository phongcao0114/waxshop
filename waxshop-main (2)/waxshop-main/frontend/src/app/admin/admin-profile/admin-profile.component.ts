...
export class AdminProfileComponent implements OnInit {
  ...
  loadProfile() {
    ...
    this.http.get<AdminProfile>(`${environment.backendUrl}/api/users/profile`, {
  ...
  updateProfile() {
    ...
    const updateData: AdminProfileUpdate = this.profileForm.value;
    
    this.http.put<AdminProfile>(`${environment.backendUrl}/api/users/profile`, updateData, {
