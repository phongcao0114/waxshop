...
export class AdminService {
  ...
  disableUser(id: number): Observable<void> {
    return this.http.patch<void>(`${this.apiUrl}/admin/users/${id}/disable`, {}, { headers: this.getAuthHeaders() });
  }

  enableUser(id: number): Observable<void> {
    return this.http.patch<void>(`${this.apiUrl}/admin/users/${id}/enable`, {}, { headers: this.getAuthHeaders() });
  }
